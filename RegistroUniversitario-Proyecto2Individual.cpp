...
void asignarCursos(vector<Estudiante>& estudiantes) {
    int codigo;
    ofstream archivo("asignaciones_cursos.txt", ios::app); // Abrimos el archivo en modo append
    ...
    while (true) {
        ...
        for (size_t i = 0; i < estudiantes.size(); ++i) {
            if (estudiantes[i].codigoEstudiante == codigo) {
                // Escribimos la información del estudiante en el archivo
                archivo << "\nASIGNACIÓN DE CURSOS\n";
                archivo << "====================================================================\n";
                archivo << "Estudiante: " << estudiantes[i].nombres << "\n";
                archivo << "Código: " << estudiantes[i].codigoEstudiante << "\n";
                archivo << "Carrera: " << estudiantes[i].carrera << "\n";
                archivo << "--------------------------------------------------------------------\n";
                ...
                for (size_t j = 0; j < cursos.size(); ++j) {
                    ...
                    while (nuevoCurso.seccion != "A" && nuevoCurso.seccion != "B" && 
                           nuevoCurso.seccion != "C" && nuevoCurso.seccion != "D") {
                    ...
                    // Escribimos la información del curso en el archivo
                    archivo << "Curso: " << nuevoCurso.nombre << "\n";
                    archivo << "Código del curso: " << nuevoCurso.codigoCurso << "\n";
                    archivo << "Sección: " << nuevoCurso.seccion << "\n";
                    archivo << "--------------------------------------------------------------------\n";
                }
                ...
                archivo << "====================================================================\n\n";
                archivo.flush(); // Aseguramos que se escriba inmediatamente en el archivo
                ...
                archivo.close(); // Cerramos el archivo antes de salir
                return;
            }    
        }
